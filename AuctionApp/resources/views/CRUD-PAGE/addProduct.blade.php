...
<!-- NAVBAR -->
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
            <a href="#" class="w-24 h-8 flex justify-center items-center text-black rounded p-10 md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white dark:hover:transition-all">Home</a>
            </li>
            <li>
...
<div class="flex w-3/4 mx-auto justify-center mt-10 flex-wrap sm:w-11/12 lg:gap-44">
    ...
    <form class="w-96 mt-40 lg:mt-60">
    <div class="grid md:grid-cols-2 md:gap-6">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <input type="range" min="100000" max="5000000" value="55" class="w-4/5 m-2 h-2 bg-gray-400 rounded-lg border-gray-400 appearance-none cursor-pointer slider" id="myRange">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <textarea id="description" class="block w-full p-2 text-sm rounded-lg text-gray-700" placeholder="Enter your description ..." required></textarea>
        </div>
    <button type="submit" class="text-white bg-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm lg:w-auto sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style="width: 384px;">Submit</button>
    </form>
    <img src="{{ asset('images/Screenshot_20240508_194557 3.png') }}" class="h-auto sm:w-auto mt-40" style="width: 450px;" alt="">
    </div>
