...
<body>
    <div class="w-auto flex flex-col justify-center items-center bg-gray-100 p-12 rounded-xl shadow-3xl" style="height:60vh;">
       ...
       <form class="max-w-sm mx-auto">
        <div class="mb-5">
            <input type="text" id="fullName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-medium rounded-xl font-poppins focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Full Name" style="background-color: #FEFDED;" required />
        </div>
        <div class="mb-5">
