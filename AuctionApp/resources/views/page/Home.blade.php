...
<body>
    ...
    <section class="h-screen flex justify-center" data-aos="fade-up" data-aos-delay="400">
        <div class="flex justify-center flex-col">
            <h1 class="ml13 mb-2 text-center text-3xl md:text-5xl lg:text-6xl" style="font-family: 'Rampart One';">Welcome To Auctions!</h1>
            <p class="font-poppins text-xl mt-4 p-3 font-medium text-center md:text-2xl lg:text-5xl">Bid, Win, and Enjoy! Dive into the <br>world of online auctions today.</p>
        </div>
    </section>
    
    <h1 class="text-center font-poppins font-bold text-4xl md:text-5xl sm:mb-8 lg:text-7xl" data-aos="fade-up" data-aos-delay="500">New Auctions!</h1>
    ...
    <section class="h-auto mb-5 flex justify-center mx-auto items-center gap-5 flex-wrap p-2 lg:w-auto sm:h-auto sm:mb-5 sm:p-10 lg:p-52" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 card" data-id="1" data-name="Phone 3" data-starting-price="200000" data-aos="fade-up" data-aos-delay="600">
                <img class="rounded-t-lg w-72 mx-auto" src="{{ asset('images/product-images/12608-removebg-preview.png') }}" alt="" />
                <div class="p-5">
                    <!-- NAMA BARANG DAN HARGA BARANG -->
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Phone 3 | Rp. 200.000</h5>
    ...
    <!-- ALERT -->
    <div id="successAlert" class="hidden fixed top-0 inset-x-0 p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
